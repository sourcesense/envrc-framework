...
. "$(fetchurl "https://raw.githubusercontent.com/EcoMind/envrc-framework/v0.12.0/_dep-bootstrap.sh" "sha256-lOYbrk89hNgXowWn1q17tpqUeNnEXJLyDTl7mLhbcpU=")" 0.5.1

dep define "log2/shell-common:0.3.2"
dep define "EcoMind/k8s-common:0.2.11"
